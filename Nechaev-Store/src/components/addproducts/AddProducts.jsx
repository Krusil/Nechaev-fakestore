    ...
    <div ref={showDivRef} className="addproducts__container">
              ...
              <tbody>
                {items.map((item, i) => (
                  <tr key={item.id}>
                    <td>{i + 1}</td>
                    <td>{item.title}</td>
                    <td><img className="icon" src="https://sergeychikin.ru/365/350-trade/dollar.svg" alt="" />{item.price}</td>
      ...
      <div className="right-side">
        <div className="right-side-header">
          ...
          >
            <img className="icon" src="https://cdn3.iconfinder.com/data/icons/feather-5/24/delete-64.png" alt="" />
          </button>
        </div>
        ...
        <div className="right-side-footer">
          ...
          <div className="footer-head">
            <h4>Total :</h4>
            <h1><img className="icon" src="https://cdn3.iconfinder.com/data/icons/feather-5/24/dollar-sign-64.png" alt="" />{total}</h1>
          </div>
